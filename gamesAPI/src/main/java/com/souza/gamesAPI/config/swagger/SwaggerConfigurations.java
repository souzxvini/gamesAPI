package com.souza.gamesAPI.config.swagger;
...
public class SwaggerConfigurations {
	...
	private ApiInfo metaInfo() {
		ApiInfo apiInfo = new ApiInfo(
				"Games API REST",
				"Faça o cadastro no 'RegistroController', depois faça a autenticação no 'AutenticacaoController' para gerar o token e ter acesso às requisições protegidas.",
				"1.0",
				"Terms of Service",
